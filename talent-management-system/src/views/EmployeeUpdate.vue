<template>
  <div style="margin-top: 30px;margin-left:330px;width: 500px;height: 500px;border: 0px solid red;" >
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      <el-form-item label="员工编号" prop="employeeID">
        <el-input v-model="ruleForm.employeeID" readonly></el-input>
      </el-form-item>
      <el-form-item label="员工姓名" prop="employeename">
        <el-input v-model="ruleForm.employeename" placeholder="请修改员工姓名"></el-input>
      </el-form-item>
      <el-form-item label="员工性别" prop="employeesex">
        <el-select v-model="ruleForm.employeesex" >
      ...
      <el-form-item label="员工职级" prop="employeelevel">
        <el-select v-model="ruleForm.employeelevel" placeholder="请修改员工职级">
      ...
      <el-form-item label="员工薪资" prop="employeesalary">
        <el-select v-model="ruleForm.employeesalary" placeholder="请修改员工薪资">
      ...
      <el-form-item label="居住地址" prop="address">
        <el-input v-model="ruleForm.address" placeholder="请修改员工地址"></el-input>
      </el-form-item>
      <el-form-item label="联系方式" prop="telephone">
        <el-input v-model="ruleForm.telephone" placeholder="请修改员工联系方式"></el-input>
      </el-form-item>
...
export default {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          axios.put('http://localhost:8181/employee/update',_this.ruleForm).then(function (resp) {
            if(resp.data.code == 0){
              _this.$alert('员工【'+_this.ruleForm.employeeID+'】信息修改成功', '', {
  ...
  created() {
    ...
    axios.get('http://localhost:8181/employee/findById/'+_this.$route.query.employeeID).then(function (resp) {
